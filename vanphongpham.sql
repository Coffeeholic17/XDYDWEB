...
-- Thời gian đã tạo: Th3 20, 2022 lúc 03:09 PM
...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `gmail` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `admin` (`maadmin`, `username`, `password`, `gmail`, `status`) VALUES
(1, 'anh thi', '123456', 'dh51802009@student.stu.edu.vn', 0),
(2, 'tran truong', '123456', 'dh51800041@student.stu.edu.vn', 0);
...
--
ALTER TABLE `sanpham`
  ADD CONSTRAINT `sanpham_ibfk_1` FOREIGN KEY (`loaisanpham`) REFERENCES `loai` (`maloai`);
COMMIT;
